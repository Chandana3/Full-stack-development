...
var regemp1 = new RegularEmployee_1.RegularEmployee(uuid_1.v4(), "chandana", "UIDeveloper", 20000);
console.log(regemp1.displayEmployeeDetails());
var regemp2 = new Consultant_1.Consultant(uuid_1.v4(), "madhu", "testing", 22000, EmployeeType_1.EmployeeType.TESTING);
regemp2.displayEmployeeDetails();
regemp2.createEmployee(uuid_1.v4(), "navya", "manager");
regemp2._hourly = 34;
